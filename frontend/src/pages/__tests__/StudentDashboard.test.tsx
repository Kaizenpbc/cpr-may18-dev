  ...
  describe('Enrollment History', () => {
    ...
    it('allows canceling an enrollment', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Enrollment cancelled successfully')
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe('Error Handling', () => {
    ...
    it('shows empty state when no enrollments exist', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Browse available courses to get started.')
        ).toBeInTheDocument();
      });
    });
    ...
    it('shows empty state when no certifications exist', async () => {
      ...
      await waitFor(() => {
        ...
        expect(
          screen.getByText('Complete courses to earn certifications.')
        ).toBeInTheDocument();
      });
    });
  });
