...
import {
  getOrganizationCourseRequestAnalytics,
  getOrganizationStudentParticipationAnalytics,
} from '../../services/api';
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12}>
          <Paper sx={{ p: 3 }}>
            ...
            <ResponsiveContainer width='100%' height={300}>
              <BarChart
                data={studentParticipationData?.classSizeOptimization || []}
              >
                <CartesianGrid strokeDasharray='3 3' />
                ...
                <Legend />
                <Bar
                  dataKey='actual_registered'
                  fill='#8884d8'
                  name='Actual Registered'
                />
                <Bar
                  dataKey='actual_attended'
                  fill='#82ca9d'
                  ...
                  <Grid item xs={12} sm={6} md={4} key={index}>
                    <Card variant='outlined'>
                      <CardContent>
                        ...
                        <Typography variant='caption' color='textSecondary'>
                          {item.completed_courses} of {item.total_courses}{' '}
                          courses completed
                        </Typography>
