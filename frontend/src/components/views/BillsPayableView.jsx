...
const BillsPayableView = () => {
    ...
    const { data: invoicesData, isLoading: invoicesLoading, refetch } = useQuery({
        ...
        queryFn: async () => {
            ...
            const response = await api.get('/api/v1/organization/invoices', { params });
            return response.data.data;
        }
    });
    ...
    const submitPaymentMutation = useMutation({
        mutationFn: async ({ invoiceId, paymentData }) => {
            const response = await api.post(`/api/v1/organization/invoices/${invoiceId}/payment-submission`, paymentData);
                ...
                <Grid item xs={12} sm={6} lg={3}>
                    ...
                    >
                        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                            ...
                            >
                                <Box sx={{ flex: 1 }}>
                                    <Typography variant={{ xs: 'h5', sm: 'h6' }} component="div" fontWeight="bold">
                                        {summary?.pending_invoices || 0}
                                    </Typography>
                                    <Typography variant="body2" sx={{ fontSize: { xs: '0.875rem', sm: '0.75rem' } }}>
                                        Pending Invoices
                                    </Typography>
                                </Box>
                                <PendingIcon sx={{ fontSize: { xs: 32, sm: 40 }, opacity: 0.8 }} />
                            </Box>
                            <Typography variant={{ xs: 'h6', sm: 'h6' }} sx={{ mt: 1 }} fontWeight="medium">
                    ...
                    >
                        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                            ...
                            >
                                ...
                                <WarningIcon sx={{ fontSize: { xs: 32, sm: 40 }, opacity: 0.8 }} />
                            </Box>
                            <Typography variant={{ xs: 'h6', sm: 'h6' }} sx={{ mt: 1 }} fontWeight="medium">
                    ...
                    >
                        <CardContent sx={{ p: { xs: 2, sm: 3 } }}>
                            ...
                            >
                                ...
                                <SubmittedIcon sx={{ fontSize: { xs: 32, sm: 40 }, opacity: 0.8 }} />
                            </Box>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <DialogContent>
                    <Box sx={{ pt: 2 }}>
                        ...
                        <Alert severity="info" sx={{ mt: 2 }}>
                            Report payment information after you have sent payment to GTA through your bank or other payment method. 
                            Our accounting team will verify the payment details and update the invoice status.
                        </Alert>
                    </Box>
                </DialogContent>
                <DialogActions>
                    ...
                    >
                        {submitPaymentMutation.isLoading ? 'Reporting...' : 'Report Payment'}
                    </Button>
                </DialogActions>
            </Dialog>
